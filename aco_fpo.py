...
if __name__ == '__main__':
    ...
    for i in range(10):
        ...
        for j in tqdm(range(20)):
            ...
            acs = SolveFPOUsingACO(mode='ACS', colony_size=_colony_size, steps=_steps, nodes=_nodes)
            elitist = SolveFPOUsingACO(mode='Elitist', colony_size=_colony_size, steps=_steps, nodes=_nodes)
            max_min = SolveFPOUsingACO(mode='MaxMin', colony_size=_colony_size, steps=_steps, nodes=_nodes)
